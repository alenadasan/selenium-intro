...
public class MatchersDemo {
    ...
    public void matchersTest() {
        ...
        assertThat(firstString, allOf(containsString("Lorem"), containsString("ipsum")));
        ...
        assertThat(secondString, both(containsString("elit")).and(not(isEmptyOrNullString())));
        ...
        assertThat(anArraylist, everyItem(startsWith("F")));
    }
}
